...
import dev.skymansandy.gocorona.presentation.main.about.settings.SettingsFragment
import dev.skymansandy.gocorona.tools.constant.AppConstant.Url


class AboutFragment(override val layoutId: Int = R.layout.fragment_about) :
    BaseFragment<FragmentAboutBinding, SettingsState, SettingsEvent, AboutViewModel>() {
